      ...
      <div class="container-fluid pb-4">
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				...
				<h3>Suivi validation demande</h3>
			</div>
		</div>
        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 col-xs-4">
                        <div class="form-group form-group-sm">
                            <label for="formGroupInputSmall">Situation Validation</label>
                            <select class="form-control form-perso" id="statusID">
                                <option value="0">Choisir</option>
                                <option value="1">En attente validation</option>
                                <option value="2">Validé par notre entité</option>
                                <option value="3">Rejeté par notre entité</option>
                ...
                <div class="table-responsive">
                  <table id="tblrequestsend" class="table table-bordered table-striped m-0">
                    ...
                    <tr class="item-tr">
                        ...
                        <a href="<?php echo url("suividemande/{$requestwf->ID}");?>" class="btn btn-info">voir historique demande</a>
