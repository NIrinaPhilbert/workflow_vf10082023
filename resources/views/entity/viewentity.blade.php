        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid pb-4">
                    ...
                    <div class="col-md-12">
                        <!-- TABLE: DATA -->
                        <?php //foreach($requestentity as $req)  { ?>
                        <form method="POST" action="">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Détail Entité</h3>
                                </div>
                                <!-- /.card-header -->
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <table class="table table-bordered">
                                                    <tr class="item-tr">
                                                        <td><label>Désignation entité</label></td>
                                                    </tr>  
                                                    <tr class="item-tr">
                                                        <td>{{$oEntity->name}}</td>
                                                    </tr>
                                                    <tr class="item-tr">
                                                        <td><label>Entité parent</label></td>
                                                    </tr>  
                                                    <tr class="item-tr">
                                                        <td><?php echo $zNameEntityParent; ?></td>
                                                    </tr>
                                                    <tr class="item-tr">
                                                        <td><label>Description entité</label></td>
                                                    </tr>  
                                                    <tr class="item-tr">
                                                        <td>{{$oEntity->description}}</td>
                                                    </tr>                  
                                                    <tr class="item-tr">
                                                    ...
                                                    <tr class="item-tr">
                                                        ...
                                                        <span>
                                                            <?php 
                                                                $zDateCreation = Helper::convertDateTimeToCurrentDate($oEntity->created_at); 
                                                                echo $zDateCreation;
                                                            ?>
