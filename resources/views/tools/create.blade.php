            ...
            <section class="content">
                <div class="container-fluid pb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="<?php echo url("tool/save") ?>">
                            @csrf   
                            {{ csrf_field() }}
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Création outil</h3>
                                </div>
                                <!-- /.card-header -->
                                                ...
                                                <div class="col-lg-7 col-md-10 col-sm-12 col-xs-12 mx-auto pt-2">
                                                    <!-- ERROR MESSAGES -->
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nom outil" value="{{ old('name') }}">
                                                            @error('name')
