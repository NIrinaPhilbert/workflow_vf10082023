...
<a href="javascript:void(0)" class="btn btn-success btn-add ml-3" id="add-new-entite">Ajout Outil</a>
<br><br>
 
<table id="toolDatatable" class="display" width="100%"></table>
        ...
        <form id="entityForm" name="entityForm" class="form-horizontal">
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group">
                <label class="col-sm-6 control-label">Désignation outil</label>
                <div class="col-sm-12">
                    <input class="form-control" id="name" name="name" value="" required="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-6 control-label">Description outil</label>
                <div class="col-sm-12">
...
var dataSet = <?php echo $zToolsDatatable; ?>;
...
$('body').on('click', '.btn-delete', function () {
  ...
  $.ajax({
      ...
      var oTable = $('#toolDatatable').dataTable(); 
      location.reload();
      oTable.fnDraw(false);
      },
      error: function (data) {
