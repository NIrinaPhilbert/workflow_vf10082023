...
<a href="javascript:void(0)" class="btn btn-success btn-add ml-3" id="add-new-entite">Ajout Utilisateur</a>
<br><br>
 
<table id="userDatatable" class="display" width="100%"></table>
...
var dataSet = <?php echo $zUsersDatatable; ?>;
