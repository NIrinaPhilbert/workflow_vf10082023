    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updatepasswordtemp') }}">
                        @csrf
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="passwordtemp" type="password" class="form-control @error('password') is-invalid @enderror" name="passwordtemp" required autocomplete="new-password">
