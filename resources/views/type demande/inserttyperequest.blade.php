...
<h5>Ajout type de demande</h5>
<a href="<?php echo url("typerequestdatatable");?>" class="btn btn-info ml-3">Retour</a>
<a href="<?php echo url("/home");?>" class="btn btn-success btn-add ml-3" id="add-new-entite">Accueil</a>
<p></p>
		...
		<div class="form-group">
				...
				<div class="border-row">
					<label>Choisir les outils</label>
						<div class="input-group mb-3">
							...
							<div class="input-group-append cursor-pointer" id="btn-add-order">
								...
								<hr class="w-100 mt-3">
								<label>Outils liés au type de demande</label>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-sm-12 mt-4 mb-4 hide-data" id="data" display:none>
		...
		<br>
		<button  class="btn btn-primary" id="btn-save">Sauvegarder les informations</button>
...
<script type="text/javascript">
    	...
    	function saveParameters(dataval) {
