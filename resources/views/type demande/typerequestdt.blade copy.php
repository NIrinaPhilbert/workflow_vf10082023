...
<a href="<?php echo url("inserttyperequest");?>" class="btn btn-success btn-add3 ml-3" id="add-new-entite3">Ajout Type Demande</a>
<br><br>
 
<table id="typerequestDatatable" class="display" width="100%"></table>
...
var dataSet = <?php echo $zTyperequestsDatatable; ?>;

$(document).ready(function() 
{
    
   $('#typerequestDatatable').DataTable({
