                        ...
                        <form method="POST" action="">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Détail type demande</h3>
                                </div>
                                <!-- /.card-header -->
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr class="item-tr">
                                                        <td><label>Description type demande</label></td>
                                                    </tr>  
                                                    <tr class="item-tr">
                                                    ...
                                                    <tr class="item-tr">
                                                        <td><span>
                                                            <?php
                                                                $zDateCreation = Helper::convertDateTimeToCurrentDate($typerequest->created_at);
                                                                echo $zDateCreation;
                                                            ?>
                                                    ...
                                                    <tr class="item-tr">
                                                        <td><label>Liste outil liée à ce type de demande</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        <ol>
                                                        <?php foreach($tools_type_request as $tooltr) { ?>
                                                            <li>{{$tooltr->name}}</li>
                                                        <?php } ?>    
                                                        </ol>
                                                        </td>
