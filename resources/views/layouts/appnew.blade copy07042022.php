...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/css_template/table-style_templ.css') }}">
  <link rel="stylesheet" href="{{ asset('css/css_template/general_templ.css') }}">
  <link rel="stylesheet" href="assets/dist/css/data-style.css">
  <!--====================================================================->
