...
Route::match(['put', 'patch'], '/sendrequest/save', 'RequestwfController@store');
...
Route::get('testemail','CronController@testEnvoiEmail');
...
Route::get('supprimeruser/{id}','UserController@supprimeruser')->name('supprimeruser');
